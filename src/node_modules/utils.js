...
export function serializeSelected(countries,selectedList,dayZero){
    return countries.map(c => {
        ...
        clone.bgColor = assignColor(selectedIndex).foreground;        
...
export function assignColor(index){
    const pallete = ['#EE4266','#2A1E5C','#C4CBCA','#3CBBB1','#182825','#016FB9','#22AED1','#6D8EA0','#AFA98D'];    
    const pallete2 = ['#FBDCE3','#D8D6E1','#F4F5F5','#DBF2F0','#969D9B','#8BBDDF','#9ADAEA','#BCCBD3','#DAD7CB'];
